  ...
  <Grid item xs={12} sm={6} md={3}>
    <Box backgroundColor={colors.primary[400]} display="flex" alignItems="center" justifyContent="center" p={2}>
      <StatBox
        ...
        progress="0.6"
        increase="+12%"
        icon={<WorkIcon sx={{ color:colors.greenAccent[400]  }} />}
      />
    </Box>
  </Grid>
  ...
  <Grid item xs={12} sm={6} md={3}>
    <Box backgroundColor={colors.primary[400]} display="flex" alignItems="center" justifyContent="center" p={2}>
      <StatBox
        ...
        progress="0.8"
        increase="+18%"
        icon={<PaymentIcon sx={{ color: colors.greenAccent[400]  }} />}
      />
    </Box>
  </Grid>
</Grid>
