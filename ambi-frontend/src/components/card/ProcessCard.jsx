...
const ProcessCard = ({ cardsData }) => {
  ...
  <div className="process-left">
    <h1 className="section-process-title">
      Why Choose Us for iPhone App Development Solutions?
    </h1>
    <p className="section-process-subtitle fw-normal">
      Android mobile app development is becoming increasingly popular for its various benefits such as:
    </p>
  </div>
  ...
  <div className="process-right">
    {cardsData.map((card, index) => (
      <div className="process-cards" key={index}>
         <p className='process-cards-iicons'> {card.icon}</p>
